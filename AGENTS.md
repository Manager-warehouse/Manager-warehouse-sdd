...
<!-- SPECKIT START -->
<!-- Active Plan: .sdd/specs/004-outbound-delivery-pod/features/feature-driver-mobile-pod/plan.md -->
<!-- SPECKIT END -->

<!-- gitnexus:start -->
# GitNexus — Code Intelligence

This project is indexed by GitNexus as **Manager-warehouse-sdd** (15925 symbols, 39017 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
