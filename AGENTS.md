...
This project is indexed by GitNexus as **Manager-warehouse-sdd** (15068 symbols, 32346 relationships, 300 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
