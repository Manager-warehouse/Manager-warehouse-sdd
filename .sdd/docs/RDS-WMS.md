...
| 05 | `products`                        | Danh mục SKU (đồ gia dụng — không serial, không hạn dùng, không grade; legacy columns removed by V17).<br>- PK: `id`<br>- FK: none                                                            |
| 06 | `price_history`                   | Giá vốn/giá bán theo kỳ hiệu lực.<br>- PK: `id`<br>- FK: `product_id`                                                                                                                        |
| 07 | `batches`                         | Lô hàng theo sản phẩm + kho + ngày nhận (FIFO key); không có expiry/grade.<br>- PK: `id`<br>- FK: `product_id`, `warehouse_id`                                                                |
