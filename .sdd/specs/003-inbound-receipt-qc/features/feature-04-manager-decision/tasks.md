...
- [ ] F04-T005A Add tests that WH_MANAGER approve/reject is blocked with `STOREKEEPER_REVIEW_PENDING` while receipt is `PENDING_STOREKEEPER_REVIEW` or `RECOUNT_REQUIRED`.
...
- [ ] F04-T012 Add integration coverage for manager decision blocked before Storekeeper approval.
