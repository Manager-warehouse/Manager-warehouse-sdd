...
## 1. Context and Goal
Quản lý đội xe tải nội bộ của Phúc Anh và danh sách tài xế, theo dõi trạng thái xe (rảnh/đang đi chuyến/bảo trì) và tài xế (rảnh/đang đi chuyến/không khả dụng) để phục vụ công tác điều phối chuyến xe giao hàng và điều chuyển kho.
