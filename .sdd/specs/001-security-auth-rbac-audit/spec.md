...
**Indexes:** `idx_audit_logs_timestamp` (timestamp DESC), `idx_audit_logs_actor_id` (actor_id), `idx_audit_logs_entity` (entity_type, entity_id), `idx_audit_logs_warehouse_id` (warehouse_id)
