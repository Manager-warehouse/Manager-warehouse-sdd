...
* **Event-driven:**
  ...
  * WHEN a CEO, Warehouse Manager, or Accountant Manager opens transfer detail with reviewer access, the UI SHALL expose a read-only evidence panel grouped by business flow, not as an undifferentiated image gallery:
