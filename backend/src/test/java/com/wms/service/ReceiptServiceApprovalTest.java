 ...
 *
 * <p>Covers: happy path, invalid status, duplicate decision, stale version, forbidden warehouse.</p>
 */
...
class ReceiptServiceApprovalTest {
    ...
    // -----------------------------------------------------------------------
    // Duplicate decision: already APPROVED/RETURN_TO_SUPPLIER_PENDING/RETURNED_TO_SUPPLIER
    // -----------------------------------------------------------------------
