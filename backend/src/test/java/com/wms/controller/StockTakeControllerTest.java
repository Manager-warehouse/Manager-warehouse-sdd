 ...
 *
 * <p>Covers happy paths, validation (400), unauthenticated (401), role-scope (403),
 * and business-error mapping (409) through GlobalExceptionHandler.</p>
 */
...
class StockTakeControllerTest {
    ...
    @MockBean private StockTakeService stockTakeService;
    @MockBean private CurrentUserService currentUserService;
    @MockBean private com.wms.repository.UserRepository userRepository;
    @MockBean private com.wms.util.JwtUtil jwtUtil;
    @MockBean private com.wms.config.UserDetailsServiceImpl userDetailsService;
