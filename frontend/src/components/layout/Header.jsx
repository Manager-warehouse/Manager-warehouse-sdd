        ...
        {activeWarehouse && (
          <div className="relative min-w-0">
            <button
              ...
              className="flex max-w-[5.2rem] items-center gap-1 rounded-pill border border-hairline-light bg-canvas-cream px-2 py-1.5 text-xs font-semibold uppercase tracking-wider text-ink transition-colors hover:bg-shade-30 focus:outline-none sm:max-w-[7.5rem] sm:gap-2 sm:px-3"
            >
              <Warehouse className="hidden h-3.5 w-3.5 shrink-0 sm:block" />
              <span className="truncate">{activeWarehouse.code}</span>
              <ChevronDown className="h-3 w-3 shrink-0 text-shade-60" />
            </button>
