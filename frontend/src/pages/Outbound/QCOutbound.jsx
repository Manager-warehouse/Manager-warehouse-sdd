    ...
    (item.allocations || [])
      ...
      .map((allocation, index) => {
        ...
        return {
          ...
          qc_fail_qty: Number(allocation.qc_fail_qty || 0),
          reason: allocation.qc_fail_reason || '',
          staging_location_id: allocation.staging_location_id || defaultStagingId,
          quarantine_location_id: allocation.quarantine_location_id || defaultQuarantineId,
          notes: '',
